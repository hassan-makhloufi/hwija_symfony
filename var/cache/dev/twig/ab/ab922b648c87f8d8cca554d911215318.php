...
class __TwigTemplate_bc69d0e12cba40495cc94697a3e8f710 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 39
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_product_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 39, $this->source); })()), "id", [], "any", false, false, false, 39)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "product/show.html.twig", "/Users/hassan/Downloads/ProductsManagement/templates/product/show.html.twig");
    }
}
