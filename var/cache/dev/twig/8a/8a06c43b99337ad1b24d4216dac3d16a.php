...
class __TwigTemplate_103266e154e1a172f2021bff526973ba extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row justify-content-center\">
        <div class=\"col-md-8\">
            <div class=\"card shadow\"> <!-- Ajout d'une ombre pour plus de profondeur -->
                <div class=\"card-header bg-primary text-white\"> <!-- Utilisation de couleurs pour distinguer la tête de carte -->
                    Edit Product
                </div>
                <div class=\"card-body\">
                    ";
        ...
        echo "\" class=\"btn btn-outline-primary\">Back to list</a>
                    ";
        // line 18
        echo twig_include($this->env, $context, "product/_delete_form.html.twig", ["button_class" => "btn btn-danger", "button_label" => "Delete"]);
        // line 21
        echo "
                </div>
            </div>
...
";
    ...
    {
        return array (  110 => 21,  108 => 18,  104 => 17,  98 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
    ...
    <div class=\"row justify-content-center\">
        <div class=\"col-md-8\">
            <div class=\"card shadow\"> <!-- Ajout d'une ombre pour plus de profondeur -->
                ...
                <div class=\"card-footer d-flex justify-content-between\">
                    <a href=\"{{ path('app_product_index') }}\" class=\"btn btn-outline-primary\">Back to list</a>
...
{% endblock %}
", "product/edit.html.twig", "/Users/hassan/Desktop/ProductsManagement/templates/product/edit.html.twig");
    }
}
