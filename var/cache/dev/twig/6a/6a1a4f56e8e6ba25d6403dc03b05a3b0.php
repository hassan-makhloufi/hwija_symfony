...
class __TwigTemplate_d4ea77f8f06c6ded63a8c91efe74c7d5 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("dashboard.html.twig", "product/new.html.twig", 1);
    ...
    <div class=\"row justify-content-center\">
        <div class=\"col-md-8\">
            <div class=\"card shadow-sm\"> <!-- Ajout d'une ombre pour plus de profondeur -->
                ...
                <div class=\"card-footer d-flex justify-content-between\">
                    <a href=\"{{ path('app_product_index') }}\" class=\"btn btn-outline-info\">Back to list</a>
                </div>
            </div>
        </div>
    </div>
